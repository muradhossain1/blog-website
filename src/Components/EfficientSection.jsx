...
const EfficientSection = () => {
    return (
        <div className='mt-12'>
            <h2 className="text-2xl md:text-4xl text-center font-bold ">Quick and efficient support</h2>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-8 mt-8 border shadow-xl rounded-lg p-8 '>
                <div className='flex items-center gap-6 bg-gray-100 p-6 rounded-lg shadow-md'>
                ...
                <div className='flex gap-4 items-center bg-gray-100 p-6 rounded-lg shadow-md'>
