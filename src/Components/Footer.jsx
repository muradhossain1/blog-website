        ...
        <div className="mt-8 bg-neutral ">
            ...
            <footer className="grid grid-cols-2 md:grid-cols-4 gap-8 md:justify-around text-neutral-content mt-3 p-4 md:px-10 lg:px-20 mb-6 ">
                <nav className=" flex flex-col">
                    ...
                    <Link to='/add-blogs' className="link link-hover">Add Your Blogs</Link>
                    <Link to='/all-blogs' className="link link-hover">View Details</Link>
                    <Link to='/my-wishlist' className="link link-hover">My Wishlist</Link>
